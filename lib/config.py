...
sentinel_cfg = EmixilConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_emixild_proto_version_with_sentinel_ping = 70207


def get_emixil_conf():
    home = os.environ.get('HOME')

    emixil_conf = os.path.join(home, ".emixilcore/emixil.conf")
    if sys.platform == 'darwin':
        emixil_conf = os.path.join(home, "Library/Application Support/EmixilCore/emixil.conf")

    emixil_conf = sentinel_cfg.get('emixil_conf', emixil_conf)
