...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to emixild "gobject list" output
    ...
    def emixild_serialise(self):
        import emixillib
        return emixillib.SHIM_serialise_for_emixild(self.serialise())
